...
{
    var screenWidth = widthOf(window.document.body);
    var screenHeight = heightOf(window.document.body);
    var element = window.document.getElementById("pnlStage");
    var w = parseInt(widthOf(element));
...
var CreateStage = function(bg0XOffset)
{
    ...
    Stage.prototype.init = function()
    {
        ...
        var w = parseInt(widthOf(this.Bg.element));
        if(!w) w = 0;
        var diff = (screenWidth - w) / 2;
